...
<html>
	...
	<body>
        ...
        <main>
                ...
                <h1>Update Event</h1>
                <form action="./change-event.php" method="get" autocomplete="on">
                <input type="text" name="new_event_id" class="form-control" value ="<?php echo $event->id;?>" hidden="true">
                <label>Event name:
                        <input type="text" name="new_event_name" class="form-control" value="<?php echo $event->name;?>" required>
                </label><br><br>
                <label>Event date:
                        <input type="text" name="new_event_date" class="form-control" value ="<?php echo $event->date;?>" required>
                </label><br>
                <label>Event location:
                        <input type="text" name="new_event_location" class="form-control" value ="<?php echo $event->location;?>" required>
                </label><br>
                <label>Number of Participants:
                        <input type="text" name="new_event_participants" class="form-control" value ="<?php echo $event->participants;?>" required>
                </label><br>
                <label>Activity:
                        <input type="text" name="new_event_activity" class="form-control" value ="<?php echo $event->activity;?>" required>
                </label><br><br>
                <input type="submit"  class="form-control-bar" id="form_submit_btn" value="Submit Event Update">               
        </form>
        </section>
        </main>
        <footer>
